...
public class GlassPanePractice extends JLayeredPane {
   private JPanel glassPanel = new JPanel();

   public GlassPanePractice(JComponent myPanel) {
   ...
   private static void createAndShowGui() {
      ...
      final GlassPanePractice myGlassPaneWrapper = new GlassPanePractice(myPanel);
